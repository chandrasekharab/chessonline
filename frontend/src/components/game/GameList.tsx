...
const styles: Record<string, React.CSSProperties> = {
  count: { color: 'var(--text-4)', fontSize: 13, marginBottom: 12 },
  ...
  playerName: { fontWeight: 600, color: 'var(--text-1)', fontSize: 15 },
  vs: { color: 'var(--text-5)', fontSize: 12 },
  result: {
  ...
  meta: { display: 'flex', gap: 8, color: 'var(--text-5)', fontSize: 13, alignItems: 'center' },
