...
const styles: Record<string, React.CSSProperties> = {
  ...
  title: { fontSize: 22, fontWeight: 700, color: '#f8fafc', textAlign: 'center', marginBottom: 4 },
  subtitle: { fontSize: 16, fontWeight: 400, color: '#94a3b8', textAlign: 'center', marginBottom: 28 },
